	...
	<div class="page flex-col" id="zoomDom1">
		<div class="group1 flex-col justify-between">
			...
			<div class="box2 flex-col">
				...
				<div class="main7 flex-col justify-center align-center">
		...
		<img
			class="img2"
			referrerpolicy="no-referrer"
			src="https://lanhu.oss-cn-beijing.aliyuncs.com/SketchPng9044c52add25900fc5f5b7d85f519fa8879aa6ecd5f6b5c629753a6337194eb6"
		/>
